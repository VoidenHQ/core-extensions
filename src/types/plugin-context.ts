/**
 * CorePluginContext — extends the SDK's PluginContext with the additional APIs
 * that the Voiden host app injects at runtime (pipeline hooks, response store
 * access, extended helpers, etc.).
 *
 * All plugin.ts files in core-extensions should use this type instead of the
 * bare PluginContext from @voiden/sdk/ui.  When the SDK is updated to include
 * these APIs officially this file can be simplified or removed.
 */
